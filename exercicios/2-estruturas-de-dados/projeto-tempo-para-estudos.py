...
total_horas = int(input("Digite a média de horas estudadas por dia: "))
...
print(f"Oi {nome}, seu ritmo de estudo por semanda é de {total_dias} dias, totalizando {total_dias * total_horas} horas na semana para o curso '{curso}'.")